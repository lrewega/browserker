...
func (u *URIParserV2) Parse(uri string) (*injast.URI, error) {
...
func (u *URIParserV2) parsePath(paramLoc browserk.InjectionLocation) {
...
func (u *URIParserV2) parseQuery(paramLoc browserk.InjectionLocation) {
	for {
...
func (u *URIParserV2) parseFragment() {
...
func (u *URIParserV2) handleValueExpr(originalTok token.Token, originalLit string, paramLoc browserk.InjectionLocation) browserk.InjectionExpr {
	if originalLit == "" {
...
func (u *URIParserV2) handleIndexExpr(lit string, paramLoc browserk.InjectionLocation) browserk.InjectionExpr {
